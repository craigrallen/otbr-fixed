...
async def main() -> None:
    ...
    except (asyncio.TimeoutError, AssertionError, Exception) as e:
        print(f"Could not query adapter hardware address: {e}")
        print("Skipping migration - assuming fresh adapter with no previous settings")
        return
